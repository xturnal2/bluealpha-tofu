...
| 37 | [`azure/monitor-metric-alert`](templates/azure/monitor-metric-alert) — available | Static metric threshold with dimensions and shared actions | criteria, severity, frequency, action groups |
